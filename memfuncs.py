...
class memfunc:
    ...
    def __init__(self):
        ...
        self.engine2_dll_base = module_from_name(self.pm.process_handle, "engine2.dll")
        self.engine2_base_address = self.engine2_dll_base.lpBaseOfDll

    def searchengine2(self):
        return self.engine2_base_address

    def searchmatchmaking(self):
